...
Over a million elements matrices were handled in the second and the third approach better than 4 elements. The "1D1D CUDA" curve ends at matrix size value of 32, which makes a matrix of 1024 elements. So is that number the maximum number of threads per block.
